...
- Name: architect.spec.js >> Architect (/architect) Page >> each company has projects with descriptions and tech tags
- Location: tests/architect.spec.js:46:7
...
Locator: locator('text=Payment Tracker').first()
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text=Payment Tracker').first()
