...
- Name: architect.spec.js >> Architect (/architect) Page >> intro text "7+ years" is visible
- Location: tests/architect.spec.js:16:7
...
Call log:
  ...
  - waiting for locator('text=7+ years')
