  ...
  return (
    <div className={styles.page} role="main">
      ...
      <div className={styles.downloads}>
        <a href="/resume" className={styles.dlBtn}>
          Resume view
        </a>
        <a href="/resume/download" download="Mahesh_Inder_Full_Stack_AI.pdf" className={styles.dlBtn} onClick={trackResumeDownload}>
      ...
      <footer className={styles.footer}>
        ...
        <div className={styles.footerLinks}>
          <a href="https://www.linkedin.com/in/mahesh-inder/" target="_blank" rel="noopener noreferrer" className={styles.footerLink}>LinkedIn</a>
          <a href="https://github.com/indered" target="_blank" rel="noopener noreferrer" className={styles.footerLink}>GitHub</a>
          <a href="https://www.instagram.com/mahesh.inder_/" target="_blank" rel="noopener noreferrer" className={styles.footerLink}>Instagram</a>
        </div>
      </footer>
    </div>
  );
